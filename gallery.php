...
,GRIP UP " />
    ...
    <!-- Fonts -->
    <link href="https://fonts.googleapis.com/css?family=Open+Sans:300,400,600,700" rel="stylesheet predbect" />
...
<body>
    ...
    <div class="site-blocks-cover inner-page-cover overlay" style="background-image: url(images/sandstorm.png);" data-aos="fade" data-stellar-background-ratio="0.5">
        <div class="container">
            <div class="row align-items-center justify-content-center text-center">

                <div class="col-md-8" data-aos="fade-up" data-aos-delay="400">
                    <h1 class="text-white font-weight-light text-uppercase font-weight-bold">Our gallery</h1>
                    <p class="breadcrumb-custom"><a href="/">Home</a> <span class="mx-2">&gt;</span> <span>Our gallery</span></p>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div class="column">
                            ...
                            for ($i = $count; $i < $count + 3; $i++) :
                                ...
                                if ($count == 0) :
                                    ...
                                    echo '<img src="' . $row["upload_name"] . '" style="width:100%" alt="' . $row["upload_id"] . '"> <h4 class="py-3">'.$row["message"].'</h4>';
